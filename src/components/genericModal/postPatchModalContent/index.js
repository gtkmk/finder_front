...
const PostPatchModalContent = ({ postInfo, onClose }) => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        formDataToSend.append('reward', formData.post_reward);
        formDataToSend.append('lost_found', formData.lost_found);
        formDataToSend.append('privacy', formData.privacy);
        formDataToSend.append('category', formData.category);
        formDataToSend.append('animal_type', formData.post_animal_type);
        formDataToSend.append('animal_size', formData.post_animal_size);

        try {
            console.log("****************************")
            console.log(location)
        const response = await axios.patch(`http://localhost:8089/post?post-id=${postInfo.id}`, formDataToSend, {
            headers: {
        ...
        <form onSubmit={handleFormSubmit}>
            ...
            <Grid item xs={6}>
                ...
                <Select
                    ...
                    id="animal_type"
                    name="animal_type"
                    value={formData.post_animal_type}
                    onChange={handleInputChange}
                    required
                >
            ...
            <Grid item xs={6}>
                ...
                <Select
                    ...
                    id="animal_size"
                    name="animal_size"
                    value={formData.post_animal_size}
                    onChange={handleInputChange}
                    required
                >
